...
|-----------------------------|------------------------------------------|---------------------------|
| /napthe                      | Open recharge card menu                  | lovelypay.napthe            |
| /lovelypayadmin lichsu       | View server-wide recharge history        | lovelypay.admin.viewhistory |
| /lovelypayadmin lichsu <name> | View recharge history of specific player | lovelypay.admin.viewhistory |
| /lichsunapthe                | View recharge history                    | lovelypay.lichsunapthe      |
| /bank <amount>               | Bank deposit via QR code                 | lovelypay.banking           |
