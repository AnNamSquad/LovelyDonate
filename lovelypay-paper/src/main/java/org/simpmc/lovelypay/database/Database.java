package org.simpmc.lovelypay.database;
...
import org.simpmc.lovelypay.database.entities.*;
...
public class Database {
    ...
    public Database(DatabaseSettings db) throws SQLException {
        ...
        if (dbType.equalsIgnoreCase("mysql")) {
            ...
            jdbcUrl = "jdbc:h2:file:" + LPPlugin.getInstance().getDataFolder().getAbsolutePath() + "/lovelypay.db;AUTO_SERVER=TRUE;DB_CLOSE_ON_EXIT=TRUE";
