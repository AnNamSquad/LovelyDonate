package org.simpmc.lovelypay.config;
...
import org.simpmc.lovelypay.config.annotations.Folder;
import org.simpmc.lovelypay.config.serializers.KeySerializer;
import org.simpmc.lovelypay.config.serializers.SoundComponentSerializer;
import org.simpmc.lovelypay.config.types.*;
import org.simpmc.lovelypay.config.types.banking.PayosConfig;
import org.simpmc.lovelypay.config.types.banking.Web2mConfig;
import org.simpmc.lovelypay.config.types.card.*;
import org.simpmc.lovelypay.config.types.menu.PaymentHistoryMenuConfig;
import org.simpmc.lovelypay.config.types.menu.ServerPaymentHistoryMenuConfig;
import org.simpmc.lovelypay.config.types.menu.card.CardListMenuConfig;
import org.simpmc.lovelypay.config.types.menu.card.CardPriceMenuConfig;
...
public class ConfigManager {
    ...
    private final YamlConfigurationProperties properties = ConfigLib.BUKKIT_DEFAULT_PROPERTIES.toBuilder()
            ...
            .header("""
                    ...
                    Shared publicly on github.com/SimpMC-Studio/LovelyPay
                    """)
            .build();
