package org.simpmc.lovelypay.config.types.menu;

import de.exlll.configlib.Comment;
import de.exlll.configlib.Configuration;
import org.bukkit.Material;
import org.simpmc.lovelypay.config.annotations.Folder;
import org.simpmc.lovelypay.config.types.data.menu.DisplayItem;
import org.simpmc.lovelypay.config.types.data.menu.RoleType;
...
public class ServerPaymentHistoryMenuConfig {
    ...
    public String title = "<gradient:#E34949:#D8DB5C><bold>LovelyPay</bold><white> Lịch Sử Nạp Server";
    ...
    public Map<Character, DisplayItem> displayItems = Map.of(
            ...
            '@', DisplayItem.builder()
                    ...
                    .lores(
                            List.of(
                                    "<color:#83E349>○<white> Tổng nạp qua ngân hàng: <green><papi:lovelypay_bank_total_formatted>",
                                    "<color:#83E349>○<white> Tổng nạp qua thẻ: <green><papi:lovelypay_card_total_formatted>",
                                    "<color:#83E349>○<white> Tổng nạp toàn server: <green><papi:lovelypay_server_total_formatted>"
                            )
                    )
                    .build()
    );
