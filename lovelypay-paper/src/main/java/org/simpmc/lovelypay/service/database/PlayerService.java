...
public class PlayerService {
    ...
    public void setFirstCharge(SPPlayer spPlayer) {
        try {
            ...
            LPPlugin.getService(DatabaseService.class).getPlayerDataService().upsertKeyValue(spPlayer, "first_charge", "true");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean hasFirstCharge(SPPlayer spPlayer) {
        try {
            // check if key is true
            String value = LPPlugin.getService(DatabaseService.class).getPlayerDataService().getValue(spPlayer, "first_charge");
