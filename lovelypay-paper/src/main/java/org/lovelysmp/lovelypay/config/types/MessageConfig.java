...
import org.lovelysmp.lovelypay.config.types.data.SoundConfig;
...
public class MessageConfig {
    ...
    // <gradient:#f9535c:#FCD05C>LovelyPay</gradient>
    @Comment({"Tất cả message đều hỗ trợ PlaceholderAPI dưới dạng [papi:<placeholder>]",
            "Không điền % %, ví dụ <papi:player_name>"})
    public String prefix = "<dark_gray>[<gradient:#E34949:#D8DB5C><bold>LovelyPay</bold><dark_gray>] <reset>";
