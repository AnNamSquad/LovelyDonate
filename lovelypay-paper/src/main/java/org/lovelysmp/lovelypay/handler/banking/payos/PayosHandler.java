package org.lovelysmp.lovelypay.handler.banking.payos;
...
import org.lovelysmp.lovelypay.data.bank.payos.PayosAdapter;
import org.lovelysmp.lovelypay.event.PaymentBankPromptEvent;
import org.lovelysmp.lovelypay.event.PaymentQueueSuccessEvent;
import org.lovelysmp.lovelypay.handler.BankHandler;
import org.lovelysmp.lovelypay.handler.banking.data.BankingData;
import org.lovelysmp.lovelypay.handler.banking.payos.data.PayosPayment;
import org.lovelysmp.lovelypay.handler.banking.payos.data.PayosResponse;
...
import org.lovelysmp.lovelypay.service.OrderIDService;
import org.lovelysmp.lovelypay.util.GsonUtil;
import org.lovelysmp.lovelypay.util.HashUtils;
...
public class PayosHandler extends BankHandler {
    ...
    private @NotNull String post(String base, PayosConfig config, String payload) throws IOException {
        ...
        connection.setRequestProperty("x-partner-code", "lovelysmp");
