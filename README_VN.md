...
**Server hỗ trợ:** Purpur 1.21.11, chạy bằng Java 21 hoặc Java 25.
...
|-----------------------------|-----------------------------------------|---------------------------|
| /napthe                       | Mở menu nạp thẻ                         | lovelypay.napthe            |
| /lovelypayadmin lichsu        | Xem lịch sử nạp toàn server             | lovelypay.admin.viewhistory |
| /lovelypayadmin lichsu <name> | Xem lịch sử nạp của người chơi chỉ định | lovelypay.admin.viewhistory |
| /lichsunapthe                 | Xem lịch sử nạp                         | lovelypay.lichsunapthe      |
| /bank <số tiền>               | Nạp ngân hàng qua mã QR                 | lovelypay.banking           |
...
|----------------------------------|----------------------------------------------------|---------|
| %lovelypay_total%                  | Trả về tổng nạp của người chơi đó                  |         |
| %lovelypay_total_formatted%        | Trả về số tiền nạp của người chơi đó dạng xxx.xxxđ |         |
| %lovelypay_server_total%           | Trả về tổng nạp toàn server                        |         |
| %lovelypay_server_total_formatted% | Trả về số tiền nạp toàn server dạng xxx.xxxđ       |         |
| %lovelypay_bank_total_formatted%   | Trả về số tiền nạp ngân hàng dạng xxx.xxxđ         |         |
| %lovelypay_card_total_formatted%   | Trả về số tiền nạp thẻ dạng xxx.xxxđ               |         |
| %lovelypay_end_promo%              | Trả về thời gian kết thúc khuyến mãi dạng dd/MM/yyyy HH:mm |         |

**Config plugin:**

Cấu trúc thư mục `./plugins/LovelyPay` như sau
